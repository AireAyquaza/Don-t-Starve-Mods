...
local assets =
{
    ...
    Asset( "IMAGE", "images/inventoryimages/spore_tall.tex" ),
    Asset( "ATLAS", "images/inventoryimages/spore_tall.xml" ),
    Asset( "IMAGE", "images/inventoryimages/spore_medium.tex" ),
    Asset( "ATLAS", "images/inventoryimages/spore_medium.xml" ),
    Asset( "IMAGE", "images/inventoryimages/spore_small.tex" ),
    Asset( "ATLAS", "images/inventoryimages/spore_small.xml" ),
...
local function onpickup(inst)
    ...
    local p = inst.components.perishable:GetPercent()
    inst.components.perishable:SetPerishTime(TUNING.TOTAL_DAY_TIME * 10) 
    inst.components.perishable:SetPercent(p)
