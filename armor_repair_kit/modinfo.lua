...
description = "Add repair kit to repair armor parts."
author = "Aire Ayquaza"
version = "1.0.0"
...
server_filter_tags = {"armor","tool","repair","kit"}

configuration_options =
{
	{
        name = "armor_repair_kit_uses",
        label = "Armor repair kit uses",
        options = 
        {
	...
	{
        name = "armor_repair_kit_repair_value",
        label = "Armor repair kit repair value",
		hover = "This is the amount of durability the armor part will recover.",
        options = 
        {
	...
	{
		name = "armor_repair_kit_allow_night_armor",
		label = "Allow Night armor",
		options =
		{
	...
	{
		name = "recipe_custone_amount",
		label = "Recipe - Needded cutstone",
		options =
		{
	...
	{
		name = "recipe_boards_amount",
		label = "Recipe - Needded boards",
		options =
		{
			{description = "1", data = 1},
			{description = "2", data = 2},
	...
	{
		name = "recipe_rope_amount",
		label = "Recipe - Needded rope",
		options =
		{
			{description = "1", data = 1},
			{description = "2", data = 2},
