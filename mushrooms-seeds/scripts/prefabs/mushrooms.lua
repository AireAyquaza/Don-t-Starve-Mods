...
local function MakeMushroom(data)
	...
	local assets_seeds =
	{
		Asset("ATLAS", "images/inventoryimages/"..data.pickloot.."_seeds.xml"),
		Asset("IMAGES", "images/inventoryimages/"..data.pickloot.."_seeds.tex"),
	}
	...
	local function fn_seeds()
		...
		inst.components.inventoryitem.imagename = data.pickloot.."_seeds"
	    inst.components.inventoryitem.atlasname = "images/inventoryimages/"..data.pickloot.."_seeds.xml"
		...
		inst.components.plantable.product = data.pickloot
    ...
    return Prefab( "forest/objects/"..data.name, mushfn, mushassets, prefabs),
		   ...
		   Prefab( "common/inventory/"..data.pickloot.."_seeds", fn_seeds, assets_seeds)
end
