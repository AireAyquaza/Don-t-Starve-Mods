...
local marblewallrecipe = GLOBAL.Recipe("wall_pomarble_item", {Ingredient("marble", 6)}, RECIPETABS.TOWN, TECH.SCIENCE_TWO, nil, nil, nil, 6)
marblewallrecipe.atlas = "images/inventoryimages/wall_pomarble_item.xml"

-- workshop-521704888 = Wall Health Regen
